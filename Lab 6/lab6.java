...
class system {
    ...
    system(String regNo, String name, String email, String phone, String className, String Department) {
        this.regNo = regNo;
        this.name = name;
        this.phone = phone;
        this.email = email;
...
public class lab6 {
    ...
    private static system[] students = new system[MAXi];
    ...
    private static void addStudent(Scanner scanner) {
        ...
        system student = new system(regNo, name, email, phone, className, department);
    ...
    private static void updateStudent(Scanner scanner) {
        ...
        students[index] = new system(regNo, name, email, phone, className, department);
